...
const securityHeaders = {
  ...
  'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; connect-src 'self' https://*.supabase.co https://*.farcaster.xyz https://*.zora.co https://*.filcdn.io; img-src 'self' data: blob: https://*.farcaster.xyz https://*.zora.co; media-src 'self' blob: https://*.filcdn.io; style-src 'self' 'unsafe-inline';"
};
