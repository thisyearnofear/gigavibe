...
export default function CommunityPortfolio() {
  ...
  const { getUserContributions, getUserPortfolioValue } =
    useCommunityOwnership();
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-400">
          Connect your wallet to view your community contributions
        </p>
      </div>
    );
  }

  const contributionStats = userContributions.reduce(
    (stats, { contribution }) => {
      stats[contribution.contributionType] =
        (stats[contribution.contributionType] || 0) + 1;
      return stats;
    },
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="bg-gray-900 border-gray-800">
          ...
          <CardContent>
            ...
            <div className="text-sm text-gray-400">Across all performances</div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gray-900 border-gray-800">
          ...
          <CardContent>
            ...
            <div className="text-sm text-gray-400">Community-owned assets</div>
          </CardContent>
        </Card>
      </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 ${getContributionColor(
                          coin.contributionType
                        )
                          .replace("text-", "bg-")
                          .replace(
                            "-400",
                      ...
                      >
                        {React.createElement(
                          getContributionIcon(coin.contributionType),
                          {
                            className: `w-5 h-5 ${getContributionColor(
                              coin.contributionType
                            )}`,
                          }
                        )}
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-400">
                          {getContributionLabel(coin.contributionType)} •{" "}
                          {(coin.percentage * 100).toFixed(1)}% ownership
                        </div>
                      </div>
                    </div>
      ...
      <Card className="bg-gray-900 border-gray-800">
        ...
        <CardContent>
          <div className="space-y-3">
            {userContributions
              .slice(0, 10)
              .map(({ performanceId, contribution }, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-400">
                        Performance #{performanceId.slice(-6)} •{" "}
